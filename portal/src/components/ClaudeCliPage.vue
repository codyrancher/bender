...
function handleDragEnter(e: DragEvent) {
  ...
  e.preventDefault()
  dragCounter++
  if (dragCounter === 1) dragOver.value = true
}
...
<template>
  <div class="cli-page">
    ...
    <Teleport to="body">
      ...
      <div v-if="showEditor" class="md-overlay" @mousedown.self="!mdSaving && (showEditor = false)">
        <div class="md-modal">
          ...
          <div class="md-modal-buttons">
            ...
            <button class="md-cancel" :disabled="mdSaving" @click="showEditor = false">Cancel</button>
...
.drop-overlay {
  position: absolute;
  inset: 0;
  background: rgba(176, 104, 160, 0.08);
