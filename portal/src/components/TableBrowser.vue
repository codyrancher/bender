...
// Browse and bulk-manage the insights DB tables: a tab per table, paginated
// rows, row selection, and delete. Self-loads; exposes refresh() so the panel
// can re-pull the table list after an ad-hoc query may have changed it.
...
defineExpose({ refresh: loadTables })
</script>
